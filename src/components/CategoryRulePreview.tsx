...
export function CategoryRulePreview({ name, plus, minus, active }: {
  name: string;
  plus: string[];
  minus: string[];
  active: boolean;
    ...
    <section aria-labelledby="category-preview-heading" className="rounded-lg border border-zinc-700 bg-zinc-950 p-4 sm:p-6 space-y-4">
      ...
      <details className="text-sm text-zinc-400">
        ...
        <ul className="mt-3 list-disc pl-5 space-y-2">
          ...
          <li>Режим источника «Всё» сохраняет сообщения и без совпадения категории. Действующий режим «Целевые» дополнительно проверяет контакт, качество и другие условия; отсутствие совпадения само по себе пока не запрещает публикацию в «Другое».</li>
        </ul>
      </details>
